...
function (_Drawable) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_7___default()(Chart, [{
    ...
    key: "makeChartFactory",
    value: function makeChartFactory(type) {
...
function (_Eventful) {
  ...
  function Drawable(drawable) {
    ...
    _this.debug = _lib__WEBPACK_IMPORTED_MODULE_12__["debug"].extend(_this.id);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                throw new _Errors__WEBPACK_IMPORTED_MODULE_10__["DataError"]("Could not draw, data is ".concat(this.data));
...
/*!**************************!*\
  !*** ./src/lib/index.ts ***!
  \**************************/
/*! exports provided: debug, getWindowInstance, addEvent, createDataTable */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 0:
/*!*************************************************!*\
  !*** multi ./src/lava.ts ./examples/js/site.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/lava.ts */"./src/lava.ts");
module.exports = __webpack_require__(/*! ./examples/js/site.js */"./examples/js/site.js");
