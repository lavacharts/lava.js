// Type definitions for Google Visualization Apis
// Project: https://developers.google.com/chart/
// Definitions by: Dan Ludwig <https://github.com/danludwig>, Gregory Moore <https://github.com/gmoore-sjcorg>, Dan Manastireanu <https://github.com/danmana>, Michael Cheng <https://github.com/mlcheng>, Ivan Bisultanov <https://github.com/IvanBisultanov>, Gleb Mazovetskiy <https://github.com/glebm>, Shrujal Shah <https://github.com/shrujalshah28>, Kevin Hill <https://github.com/kevinkhill>
...
declare namespace google {
  ...
  export namespace visualization {
    ...
    export interface QueryOptions {
      sendMethod?: string;
      makeRequestParams?: Record<string, any>;
    }
    ...
    export class QueryResponse {
      constructor(responseObject: Record<string, any>);
    ...
    export class Calendar extends ChartBase {
      ...
      getBoundingBox(id: string): Record<string, any>;
      getSelection(): any[];
      setSelection(): void;
      clearChart(): void;
    }
    ...
    export interface CalendarOptions {
      calendar: {
        cellColor: Record<string, any>;
        cellSize: number;
        dayOfWeekLabel: Record<string, any>;
        dayOfWeekRightSpace: number;
        daysOfWeek: string;
        focusedCellColor: Record<string, any>;
        monthLabel: Record<string, any>;
        monthOutlineColor: Record<string, any>;
        underMonthSpace: number;
        underYearSpace: number;
        unusedMonthOutlineColor: Record<string, any>;
      };
      colorAxis?: {
        colors: string[];
        maxValue: number;
      ...
      forceIFrame?: boolean;
      height?: number;
      noDataPattern?: Record<string, any>;
      tooltip: {
        isHtml: boolean;
      };
      width?: number;
    ...
    export class ColorFormat extends DefaultFormatter {
       ...
       *import { Dashboard } from './google.visualization.d';
