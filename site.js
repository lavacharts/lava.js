...
/* harmony import */ var _Drawable__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Drawable */ "./src/Drawable.ts");
...
function (_Drawable) {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                Object.keys(this.events).forEach(function (event) {
                  ...
                  _this2.registerEventHandler(e, _this2.events[e]);
                });
  ...
  return Chart;
}(_Drawable__WEBPACK_IMPORTED_MODULE_10__["default"]);
...
function () {
  ...
  function DataQuery(url, opts, transformer) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "debug", void 0);

    this.debug = Object(_lib_logger__WEBPACK_IMPORTED_MODULE_5__["getLogger"])().extend("DataQuery");
    this.opts = {
      sendMethod: "auto"
    };
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(DataQuery, [{
    ...
    value: function send() {
      ...
      return new Promise(function (resolve, reject) {
        _this.debug("Requesting ".concat(_this.url));
...
/* harmony import */ var _DataQuery__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./DataQuery */ "./src/DataQuery.ts");
/* harmony import */ var _Errors__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Errors */ "./src/Errors.ts");
/* harmony import */ var _Eventful__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Eventful */ "./src/Eventful.ts");
/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./lib */ "./src/lib/index.ts");
/* harmony import */ var _lib_logger__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./lib/logger */ "./src/lib/logger.ts");
...
function (_Eventful) {
  ...
  function Drawable(drawable) {
    ...
    _this.debug = Object(_lib_logger__WEBPACK_IMPORTED_MODULE_13__["getLogger"])().extend(_this.id);
    _this._lava = Object(_lib__WEBPACK_IMPORTED_MODULE_12__["getWindowInstance"])();

    _this._lava.on(_Eventful__WEBPACK_IMPORTED_MODULE_11__["EVENTS"].DRAW, function () {
      return _this.draw();
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Drawable, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                this.data = Object(_lib__WEBPACK_IMPORTED_MODULE_12__["createDataTable"])(payload);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                autoRedraw = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : true;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(payload) {
    ...
    key: "updateOptions",
    value: function updateOptions(payload) {
    ...
    value: function registerEventHandler(event, handler) {
      var _this2 = this;

      google.visualization.events.addListener(this.googleChart, event, function (e) {
        _this2.debug("Registering handler for <".concat(event, ">"));

        handler({
          event: e,
          data: _this2.data,
          chart: _this2.googleChart
        });
      });
    }
  }, {
  ...
  return Drawable;
}(_Eventful__WEBPACK_IMPORTED_MODULE_11__["default"]);
...
function (_Eventful) {
  ...
  function GoogleLoader(options) {
    ...
    _this.debug = Object(_lib_logger__WEBPACK_IMPORTED_MODULE_10__["getLogger"])().extend("GoogleLoader");
    return _this;
  }
  /**
...
function (_Eventful) {
  ...
  function LavaJs(options) {
    ...
    if (_this.options.responsive === true) {
...
function getLocalStorage() {
  if (window.localStorage && "development" === "development") {
...
/*!***************************!*\
  !*** ./src/lib/logger.ts ***!
  \***************************/
/*! exports provided: getLogger, ConsoleLogger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var debug = debug__WEBPACK_IMPORTED_MODULE_0___default()("LavaJs");
function getLogger() {
  return debug;
}
var ConsoleLogger = {
